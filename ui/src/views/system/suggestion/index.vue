  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="内容:" prop="context">
          <el-input  type="textarea":rows="5" v-model="form.context" placeholder="请输入内容" :disabled="disable"/>
        </el-form-item>
        <br/>
        <br/>
        <hr>
        <el-form-item label="回复:" prop="remark" >
          <el-input v-model="form.remark" type="textarea":rows="5" placeholder="提交后等待管理员回复" disabled="true"/>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button  type="primary" @click="submitForm" v-show="visible">确 定</el-button>
